...
using Eluant;
using OpenRA.Mods.Archipelago.Traits;
using OpenRA.Mods.Common;
using OpenRA.Mods.Common.Traits;
using OpenRA.Scripting;
using OpenRA.Traits;

namespace OpenRA.Mods.Archipelago.Scripting
{
	[ScriptPropertyGroup("APMissionObjectives")]
	public class APMissionObjectiveProperties : ScriptPlayerProperties, Requires<APMissionObjectivesInfo>
	{
		readonly APMissionObjectives mo;
		readonly bool shortGame;

		public APMissionObjectiveProperties(ScriptContext context, Player player)
			: base(context, player)
		{
			mo = player.PlayerActor.Trait<APMissionObjectives>();
