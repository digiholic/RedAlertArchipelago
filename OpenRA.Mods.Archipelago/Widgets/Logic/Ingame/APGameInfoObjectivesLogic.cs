...
{
	sealed class APGameInfoObjectivesLogic : ChromeLogic
	{
		[FluentReference]
		...
		public APGameInfoObjectivesLogic(Widget widget, World world)
		{
			...
			var mo = player.PlayerActor.TraitOrDefault<APMissionObjectives>();
			if (mo == null)
			{
				objectivesPanel.RemoveChildren();
				return;
		...
		static void PopulateObjectivesList(APMissionObjectives mo, ScrollPanelWidget parent, ContainerWidget template)
		{
